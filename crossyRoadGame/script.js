...
// Audio elements
const jumpSound = new Audio('cartoon-jump-6462.mp3');
const backgroundMusic = new Audio('background-music-224633.mp3');
...
document.querySelector("#retry").addEventListener("click", () => {
  // Simply close the game by stopping the animation and hiding the game
  gameOver = true;
  endDOM.style.visibility = "hidden";
  // Optionally, you could add a message or redirect here
...
function endGame() {
  ...
  const score = parseInt(counterDOM.innerHTML) || 0;
  sendScore(score);
}
...
function animate(timestamp) {
  ...
  if (startMoving) {
    ...
    startMoving = false;
    // Play jump sound when starting to move
    jumpSound.currentTime = 0; // Rewind to start in case it's already playing
